# [ARCHIVED] Plan: Auto-Generated `ontology.md` from Build

> [!NOTE]
> **Status: Completed & Archived**.
> This plan was successfully implemented. `OntologyGen` (`src/Tools/CodeExplorer.OntologyGen`) scans `[OntologyNode]`, `[OntologyEdge<>]`, `[OntologyProperty]`, and `[OntologyRelationship]` attributes and regenerates [`docs/ontology.md`](../ontology.md) on every build.
> This document is retained solely for historical design context.

---

## Current State Assessment (At time of proposal)
