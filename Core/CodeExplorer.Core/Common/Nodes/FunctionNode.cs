...
[OntologyNode("Represents a parsed method, function, subroutine, or procedure.", "`(File|Class|Interface)-[:CONTAINS]->(Function)`", "`(Function)-[:CALLS]->(Function)`", "`(Function)-[:USES_TYPE]->(Class|Interface)`")]
